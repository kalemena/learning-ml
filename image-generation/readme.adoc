...
.JWST Deep Space Diffusion (JWST-Deep-Space.ckpt)

* link:https://huggingface.co/dallinmackay/JWST-Deep-Space-diffusion[JWST-Deep-Space-diffusion]
...
image:images/00078-1778192444-jwst.png[200,200,link="images/00078-1778192444-jwst.txt]
