...
Source link:https://medium.com/@ageitgey/build-a-hardware-based-face-recognition-system-for-150-with-the-nvidia-jetson-nano-and-python-a25cb8c891fd[]
...
# SKIP $ git clone https://github.com/JetsonHacksNano/installSwapfile
# SKIP $ ./installSwapfile/installSwapfile.sh

### Build numpy
# SKIP $ pip3 install numpy

### Install Face reco app
$ sudo pip3 install face_recognition

# ALT: https://github.com/ageitgey/face_recognition#python-code-examples
----
====
